...
Systemd is first program that runs and it is responsible for booting process of OS. its quality of parallel execution process make it faster than traditional init.Most of the modern distribution of Linux uses systemd.It matters because it is responsible for booting process.
